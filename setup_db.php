...
// SQL to create tables (excluding 'USE railway' to avoid errors)
$sql = "
-- Users table
...
// Split by semicolon to run each query individually
$queries = explode(';', $sql);
...
foreach ($queries as $query) {
    ...
    if (!empty($query)) {
        if ($conn->query($query)) {
            ...
            echo "Query: " . htmlspecialchars(substr($query, 0, 100)) . "...<br><br>";
        }
    }
}
